...
function createRow(r) {
    ...
    body === null || body === void 0 ? void 0 : body.appendChild(row);
}
function createLetterLabels() {
    ...
    body === null || body === void 0 ? void 0 : body.appendChild(labelsRow);
}
...
function createMovings(x, y) {
    ...
    const distanses = [1, 2].reduce((acc, el) => acc.concat(el, el * -1), []);
    //вычисляем новый массив передвижений
    distanses.forEach((rowDist) => {
        distanses.forEach((cellDist) => {
            if (Math.abs(rowDist) + Math.abs(cellDist) === 3 &&
...
createChessboard();
body === null || body === void 0 ? void 0 : body.addEventListener("click", (event) => {
    ...
    if (id) {
        ...
        checked === null || checked === void 0 ? void 0 : checked.classList.add("checked");
        let [x, y] = id.split("");
